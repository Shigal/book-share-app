...
export class FeedbackService extends BaseService {
   ...
   */
  findAllFeedbacksByBook$Response(params: FindAllFeedbacksByBook$Params, context?: HttpContext): Observable<StrictHttpResponse<PagedResponseFeedbackResponse>> {
   ...
   * This method doesn't expect any request body.
   */
  findAllFeedbacksByBook(params: FindAllFeedbacksByBook$Params, context?: HttpContext): Observable<PagedResponseFeedbackResponse> {
