...
import { PagedResponseBookResponse } from '../models/paged-response-book-response';
import { PagedResponseBorrowedBookResponse } from '../models/paged-response-borrowed-book-response';
...
import { uploadBookCoverImg } from '../fn/book/upload-book-cover-img';
import { UploadBookCoverImg$Params } from '../fn/book/upload-book-cover-img';
...
export class BookService extends BaseService {
   ...
   */
  findAllBooks$Response(params?: FindAllBooks$Params, context?: HttpContext): Observable<StrictHttpResponse<PagedResponseBookResponse>> {
   ...
   * This method doesn't expect any request body.
   */
  findAllBooks(params?: FindAllBooks$Params, context?: HttpContext): Observable<PagedResponseBookResponse> {
    return this.findAllBooks$Response(params, context).pipe(
      map((r: StrictHttpResponse<PagedResponseBookResponse>): PagedResponseBookResponse => r.body)
    );
  }
  ...
  static readonly UploadBookCoverImgPath = '/books/cover/{book-id}';
   ...
   * This method doesn't expect any request body.
   */
  findAllReturnedBooks$Response(params?: FindAllReturnedBooks$Params, context?: HttpContext): Observable<StrictHttpResponse<PagedResponseBorrowedBookResponse>> {
   ...
   * This method doesn't expect any request body.
   */
  findAllReturnedBooks(params?: FindAllReturnedBooks$Params, context?: HttpContext): Observable<PagedResponseBorrowedBookResponse> {
    return this.findAllReturnedBooks$Response(params, context).pipe(
      map((r: StrictHttpResponse<PagedResponseBorrowedBookResponse>): PagedResponseBorrowedBookResponse => r.body)
    );
  }
   ...
   * This method doesn't expect any request body.
   */
  findAllBooksByOwner$Response(params?: FindAllBooksByOwner$Params, context?: HttpContext): Observable<StrictHttpResponse<PagedResponseBookResponse>> {
   ...
   * This method doesn't expect any request body.
   */
  findAllBooksByOwner(params?: FindAllBooksByOwner$Params, context?: HttpContext): Observable<PagedResponseBookResponse> {
   ...
   * This method doesn't expect any request body.
   */
  findAllBorrowedBooks$Response(params?: FindAllBorrowedBooks$Params, context?: HttpContext): Observable<StrictHttpResponse<PagedResponseBorrowedBookResponse>> {
   ...
   * This method doesn't expect any request body.
   */
  findAllBorrowedBooks(params?: FindAllBorrowedBooks$Params, context?: HttpContext): Observable<PagedResponseBorrowedBookResponse> {
